          ...
          <div class="card">
              ...
              <div class="card-footer bg-info">
                <div class="d-flex justify-content-center link" id="thu">
                    <a href="login.php" class="text-white">Quay lại trang đăng nhập</a>
                </div>
                <button onclick="xemtt()" style="border-radius: 5px;color: #09F;"><b>Xem</b></button>
                <p id="d1" style="color: #09F;border: 1px solid #FFF; background: #FFF;border-radius: 5px;"></p>
                <p id="d2" style="color: #09F;border: 1px solid #FFF; background: #FFF;border-radius: 5px;"></p>
                <p id="d3" style="color: #09F;border: 1px solid #FFF; background: #FFF;border-radius: 5px;"></p>
              </div>
          </div>
        </div>
    </div>
