...
<?php require_once './inc/header.php'?>
  <div class="container-fluid">
    <div class="row">
      <div class="anhnen">
          <img src="public/image/nen.jpg" height="400px" width="100%" id="anhnen-a">
      ...
      <div class="carousel-caption">
          <div class="row">
            <div class="col-md-12 p-b text-white">
              <h1 class="text-uppercase"><b>NH22</b></h1>
              <h2>Văn Phòng Phẩm Online</h2>
            </div>
          </div>
        </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3"> 
        <div class="pt01">
          <img src="public/image/sanpham04.jpg">
          <div class="text-center">
            <h5>THƯỚC NHỰA</h5>
            <a href="" class="btn"><h5 class="ctsp card p-2">CHI TIẾT SẢN PHẨM</h5></a>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3"> 
        <div class="pt01">
          <img src="public/image/sanpham08.png">
          <div class="text-center">
            <h5>DẤY THAN</h5>
            <a href="" class="btn"><h5 class="ctsp card p-2">CHI TIẾT SẢN PHẨM</h5></a>
          </div>
