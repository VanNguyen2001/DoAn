  ...
  <div class="container-fluid">
    <div class="container">
      <div class="row p-4">
        ...
        <div class="col-md-4">
          <h3><b>TẬP ĐỰNG HỒ SƠ - 3.5 F</b></h3>
          <h4 class="text-info"><b>19.000 VNĐ</b></h4>
          <br>
          ...
          <br>
          <a href="" class="btn nh22-02 text-white text-center p-1" data-bs-toggle="modal" data-bs-target="#themvaogiohang"><h5 class="ctsp">THỀM VÀO GIỎ HÀNG</h5></a>
          <div class="row"> 
