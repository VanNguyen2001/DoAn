...
<body class="bg-l">
  <div class="container-fluid">
    <div class="container">
     <div class="row pp">
       <div class="col-md-2">
         <a href="index.php" class="btn card bg-info p-1"><h6 class="text-white"><b>Trở lại</b></h6></a>
       </div>
     </div> 
    </div>
  </div>
          ...
          <div class="card w-500">
              ...
              <div class="card-footer bg-info">
                <div class="d-flex justify-content-center link">
                    Bạn chưa có tài khoản ?<a href="signin.php" class="text-white">Đăng ký</a>
                </div>
              </div>
          </div>
        </div>
  ...
  if(((uu = "abc")&&(pu1 = "123")) || ((uu == name)&&(pu1 == pass))){
    alert("Bạn đã đăng nhập thành công");location.assign("Admin.html")
  }
  else 
